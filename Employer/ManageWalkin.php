                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td><span id="sprytextfield1">
                            <label>
                                <input type="text" name="txtTitle" id="txtTitle" placeholder="Job Name"/>
                            </label>
                          </span></td>
                        </tr>
                        <tr>
                          ...
                          <td><span id="sprytextfield2">
                            <label>
                                <input type="text" name="txtTotal" id="txtTotal" placeholder="number of vacancies" />
                            </label>
                          </span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><label>
                                  <input type="text" name="txtOther" id="txtOther" placeholder="Other Qualifications"/>
                          </label></td>
                        </tr>
                        <tr>
                          ...
                          <td><span id="sprytextarea1">
                            <label>
                                <textarea name="txtDesc" id="txtDesc" cols="25" rows="3" placeholder="write about the job"></textarea>
                            </label>
                          </span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><span id="sprytextfield4">
                            <label>
                                <input type="time" name="txtTime" id="txtTime" placeholder="H:M:S"/>
                            </label>
                          </span></td>
                        </tr>
                        <tr>
